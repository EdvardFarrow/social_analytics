...
from .views import YouTubeChannelListView, YouTubeChannelDetailView, YouTubeLoginView, YouTubeCallbackView, AddYouTubeChannelView, YouTubeStatsView, youtube_dashboard, youtube_dashboard_videos, UpdateYouTubeStatsView, trends_view, channel_trends, update_all_videos, youtube_refresh_all
...
urlpatterns = [
    ...
    path('api/youtube/update_videos/', update_all_videos, name='youtube_update_all_videos'),
